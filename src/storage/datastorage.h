 ...
 /*module          --------  kernel --------------- ---------- config --------------     ------------ app 1 -------------    ------------ app 2 -------------    ------------ app 3 ------------- */\r\n";
    ...
    void init(const BlockType& _type)
    {
        ...
        case BlockType::bcvm:
            ...
            header.push_back("10 1 49 a0040000");
            rom_addr = 0xb0200000;
            kernelflashstr = QString("1 1 25 a0040000 f 0ffc0000 " +kernelpath + "/kernel_BCVM_MV100_02_sum.mot\r\n"\
        ...
        case BlockType::bgs:
            ...
            rom_addr = 0xbc200000;
            kernelflashstr = QString("1 1 25 a0040000 f 1bfc0000 " + kernelpath +"/kernel_BGS_MV102_02_01_sum.mot\r\n"\
